...
import {GPv2SafeERC20} from 'aave-v3-origin/src/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol';
import {SafeCast} from 'openzeppelin-contracts/contracts/utils/math/SafeCast.sol';
import {IERC20} from 'aave-v3-origin/src/contracts/dependencies/openzeppelin/contracts/IERC20.sol';
...
import {IFlashLoanReceiver} from 'aave-v3-origin/src/contracts/misc/flashloan/interfaces/IFlashLoanReceiver.sol';
...
import {TokenMath} from 'aave-v3-origin/src/contracts/protocol/libraries/helpers/TokenMath.sol';
    ...
    for (uint256 i = 0; i < params.assets.length; i++) {
      ...
      if (
        ...
        BorrowLogic.executeBorrow(
          ...
          ICreditPool(params.pool).getCreditOracle()
        );
