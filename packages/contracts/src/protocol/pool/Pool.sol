...
import {VersionedInitializable} from 'aave-v3-origin/src/contracts/misc/aave-upgradeability/VersionedInitializable.sol';
...
import {IERC20WithPermit} from 'aave-v3-origin/src/contracts/interfaces/IERC20WithPermit.sol';
...
abstract contract Pool is VersionedInitializable, PoolStorage, IPool, Multicall {
  ...
  function setCreditOracle(address creditOracle) external onlyPoolAdmin {
    _creditOracle = creditOracle;
  }

  function getCreditOracle() external view returns (address) {
    return _creditOracle;
  }
